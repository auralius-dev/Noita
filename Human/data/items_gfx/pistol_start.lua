...
gun.fire_rate_wait = 0.3
gun.spread_degrees = 12
gun.speed_multiplier = 5
gun.mana_charge_speed = {95,95}
gun.mana_max = {400,400}
...
--AddGunAction( entity_id, gun.actions[1])
--AddGunAction( entity_id, gun.actions[2])
--AddGunAction( entity_id, gun.actions[3])
--AddGunAction( entity_id, gun.actions[4])
--AddGunAction( entity_id, gun.actions[5])
--AddGunAction( entity_id, gun.actions[6])
